...
export default function CategoryCircle({
  ...
  return (
    <div className="w-fit max-w-20 md:max-w-28 min-h-29 md:min-h-32 flex flex-col items-center gap-3 cursor-pointer">
      <div className="relative w-18 md:w-20 h-18 md:h-20 rounded-full border-2 border-dashed border-tints-ruby-red-100 flex items-center justify-center p-4 hover:bg-tints-ruby-red-100/10 transition-colors">
        <Image
          src={image_url}
          alt={category_name}
          width={50}
