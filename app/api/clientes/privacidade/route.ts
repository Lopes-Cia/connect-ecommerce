...
import { updatePrivacidadeCliente } from "@/lib/integration/clientesService";
...
export async function PUT(request: Request) {
  try {
    ...
    const result = await updatePrivacidadeCliente({ clienteId, patch: patch as Record<string, unknown> });
